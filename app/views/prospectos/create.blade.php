...
@section('espacio_trabajo')
    ...
    <div id="boton-activo"  >
        {{ HTML::link(URL::to('prospectos/crear'), 'Agregar empresa',array('id'=>'a_ver')) }}
    ...
    <div id="boton">
	 ...
	 <h1 class="subheader">Agregar una nueva empresa</h1>
    {{ Session::get('mensaje') }}
    {{Form::open(array('url'=>'prospectos/crear/', 'method' => 'POST','files'=> true))}}
