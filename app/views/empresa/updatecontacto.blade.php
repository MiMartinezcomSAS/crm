...
@section('espacio_trabajo')
    ...
    <div id="boton"  >
        {{ HTML::link(URL::to('clientes/crearcargo'), 'crear cargo') }}
...
{{Form::open(array('url'=>'empresa/updatecontacto/'.$perso->id, 'method' => 'POST','files'=> true))}}
    ...
    <div class="form-group">
        ...
        {{ Form::text('nombre',$perso->nombre) }}
        {{$errors->first('nombre')}}
    </div>

    <div class="form-group">
        {{ Form::label('apellido', 'Apellido') }}
        {{ Form::text('apellido',$perso->apellido) }}
        {{$errors->first('apellido')}}
    </div>

    <div class="form-group">
        {{ Form::label('id_cargo', 'Cargo') }}
        {{ Form::select('id_cargo', $cargos, $perso->id_cargo, array('class' => 'id_cargo')) }}
    </div>

    <div class="form-group">
        {{ Form::label('correo', 'Correo') }}
        {{ Form::text('correo', $perso->correo) }}
        {{$errors->first('correo')}}
    </div>

    <div class="form-group">
        {{ Form::label('tel', 'Telefono') }}
        {{ Form::text('tel', $perso->tel) }}
        {{$errors->first('tel')}}
    </div>

    <div class="form-group">
        {{ Form::label('movil', 'Movil') }}
        {{ Form::text('movil', $perso->movil) }}
        {{$errors->first('movil')}}
    </div>

    <div class="form-group">
        {{ Form::label('empresa', 'Empresa') }}
        {{ Form::select('empresa', $empresas, $perso->empresa, array('class' => 'empresa')) }}
    </div>
